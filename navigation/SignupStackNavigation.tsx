...
import Signup_Step_5 from '@/components/signupComponents/signup_step_5';
...
const SignupStackNavigation = () => {
    return (
        <SignupStack.Navigator initialRouteName="signup_step_0">
            ...
            <SignupStack.Screen name="signup_step_5" component={Signup_Step_5} options={{ headerShown: false }} />
