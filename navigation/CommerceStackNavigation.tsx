    ...
    return (
        <StepperProvider>
            <CommerceStack.Navigator initialRouteName="home">
                ...
                <CommerceStack.Screen name="new_commerce_step_0" component={New_Commerce_Step_0} options={{ headerShown: false, animation: 'none' }} />
                <CommerceStack.Screen name="new_commerce_step_1" component={New_Commerce_Step_1} options={{ headerShown: false, animation: 'none' }} />
                <CommerceStack.Screen name="new_commerce_step_2" component={New_Commerce_Step_2} options={{ headerShown: false, animation: 'none' }} />
                <CommerceStack.Screen name="new_commerce_step_3" component={New_Commerce_Step_3} options={{ headerShown: false, animation: 'none' }} />
                <CommerceStack.Screen name="new_commerce_step_4" component={New_Commerce_Step_4} options={{ headerShown: false, animation: 'none' }} />
                <CommerceStack.Screen name="new_commerce_step_5" component={New_Commerce_Step_5} options={{ headerShown: false, animation: 'none' }} />
                <CommerceStack.Screen name="new_commerce_step_6" component={New_Commerce_Step_6} options={{ headerShown: false, animation: 'none' }} />
