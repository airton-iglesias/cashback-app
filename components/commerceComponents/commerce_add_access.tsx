import { SafeAreaView, View, Text, TouchableOpacity, BackHandler, Image, ScrollView, TouchableHighlight, KeyboardAvoidingView, TextInput, Switch } from "react-native";
            ...
            <KeyboardAvoidingView style={{ flex: 1 }}>
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    <View className="relative items-start justify-end px-8 w-full h-24">
                        <TouchableOpacity onPress={() => commerceNavigation.navigate("commerce_access_manager")} style={{ position: 'absolute', left: 20, width: 40, height: 40, justifyContent: 'flex-end', alignItems: 'flex-start', paddingBottom: 3 }}>
                            <Octicons name="chevron-left" size={24} color="black" />
                        </TouchableOpacity>
                        <Text className="text-3xl ml-6 mb-1 font-bold">Adicionar acesso</Text>
